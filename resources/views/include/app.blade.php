                ...
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="sideBarli  salonsSideA">
                            <a href="{{ route('salons') }}" class="nav-link"><i class="fas fa-store"></i><span>
                                    {{ __('Salons') }} </span></a>
                        </li>

                        <li class="sideBarli  staffSideA">
                            <a href="{{ route('staff') }}" class="nav-link"><i class="fas fa-user-tie"></i><span>
                                    {{ __('Barber') }} </span></a>
                        </li>

                        <li class="sideBarli  servicesSideA">
                            <a href="{{ route('services') }}" class="nav-link"><i class="fas  fa-tasks"></i><span>
                                    {{ __('Services') }} </span></a>
                        </li>
                        <li class="sideBarli  bookingsSideA">
                            <a href="{{ route('bookings') }}" class="nav-link"><i
                        ...
                        <li class="sideBarli  bannersSideA">
                            <a href="{{ route('banners') }}" class="nav-link"><i class="far fa-image"></i><span>
                                    {{ __('Banners') }} </span></a>
                        </li>
                        ...
                        <li class="sideBarli  salonWithdrawsSideA">
                            <a href="{{ route('salonWithdraws') }}" class="nav-link"><i
                                    class="fas fa-money-bill"></i><span>
                                    {{ __('Salon Withdraws') }} </span></a>
                        </li>
                        ...
                        <li class="sideBarli  salonCategoriesSideA">
                            <a href="{{ route('salonCategories') }}" class="nav-link"><i
                                    class="fas fa-grip-horizontal"></i><span>
                                    {{ __('Salon Categories') }} </span></a>
                        </li>
